...
--
-- Host: localhost
-- Generation Time: Aug 12, 2024 at 03:07 AM
...
(5, 'Theo Omondi', 'theo@gmail.com', 6, 'Lynn & Associates', 'Driver', 'Nairobi', 'Driver must be always available', 'Full Time', 7, '2024-07-29 08:30:42', '2024-07-29 08:40:47', 0),
...
INSERT INTO `posted_jobs` (`jobId`, `jobTitle`, `jobDescription`, `jobEmploymentType`, `companyName`, `totalApplicants`, `coreQualifications`, `date_created`, `updation_date`, `status`, `jobLocation`, `job_level`, `job_salary`, `application_deadline`) VALUES
...
(6, 'Theo Omondi', 'theo@gmail.com', '$2y$10$jVhP81jG7yqxhswzY3yx9uiSkTp6SlurQbAlEIlu8D6MK6H8Vjml.', 'users/profilePhotos/20545632_1718205608475432_1916377436953848468_o.jpg', 'Nairobi', 'Data Analytics', 'KCA', '2024-07-01', '2024-07-01', 'Software Engineer', 'Self-Employed', 'self employed', 'Software Engineer', 'Nairobi', '2024-07-01 15:59:56', NULL, 'BBIT', 1, 1, 6, 1, 1, 1, ''),
...
--
ALTER TABLE `job_applications`
  MODIFY `jobApplicationId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

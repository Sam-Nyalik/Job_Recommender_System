...
<div class="breadcrumb">
    <div class="container">
        <div class="row">
            <span><a href="index.php?page=home">Home</a> | All Mid Level Jobs</span>
        </div>
    </div>
</div>
...
<div id="section_title">
    <div class="container">
        <div class="row">
            <h4 class="text-center">Mid Level Jobs</h4>
        </div>
    </div>
</div>
...
<div id="job_display">
    <div class="container">
        <div class="row">
            ...
            <?php
            $sql = $pdo->prepare("SELECT * FROM posted_jobs WHERE job_level LIKE '%Mid Level%' AND status = 1");
            $sql->execute();

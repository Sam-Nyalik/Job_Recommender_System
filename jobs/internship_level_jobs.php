<!-- INTERNSHIP & GRADUATE LEVEL JOB SECTION -->
...
<!-- Header Template -->
<?= headerTemplate('JOBS | INTERNSHIP & GRADUATE LEVEL'); ?>
...
<div class="breadcrumb">
    <div class="container">
        <div class="row">
            <span><a href="index.php?page=home">Home</a> | All Internship & Graduate Level Jobs</span>
        </div>
    </div>
</div>
...
<div id="section_title">
    <div class="container">
        <div class="row">
            <h4 class="text-center">Internship & Graduate Level Jobs</h4>
        </div>
    </div>
</div>
...
<div id="job_display">
    <div class="container">
        <div class="row">
            ...
            <?php
            $sql = $pdo->prepare("SELECT * FROM posted_jobs WHERE job_level LIKE '%Internship & Graduate%' AND status = 1");
            $sql->execute();
            $all_senior_level_jobs = $sql->fetchAll(PDO::FETCH_ASSOC);
            ?>

            <?php foreach ($all_senior_level_jobs as $senior_level_jobs) : ?>
                <div class="job_links col-md-4 mx-3">

...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    $sql = "UPDATE job_applications SET application_status = 1 WHERE jobApplicationId = $application_id";
    $stmt = $pdo->prepare($sql);
    if($stmt->execute()){
        header("location:index.php?page=admin/jobs/all_approved_job_applications");
    }
